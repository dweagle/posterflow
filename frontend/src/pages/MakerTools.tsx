                    ...
                    <div className="maker-setting-row">
                      <div>
                        ...
                        <InfoTip>
                          ...
                          from the top edge. The poster is scaled to cover the full bordered height, so it may
                          overhang the left/right border slightly rather than leave a gap at the bottom.
                        </InfoTip>
                      </div>
